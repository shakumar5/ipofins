      ...
      <div className="space-y-6">
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="text-sm font-medium text-surface-700 dark:text-surface-300">Initial Investment</label>
            <span className="text-sm font-bold text-surface-900 dark:text-white">{formatCurrency(initialValue)}</span>
          </div>
          <input
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="text-sm font-medium text-surface-700 dark:text-surface-300">Final Value</label>
            <span className="text-sm font-bold text-surface-900 dark:text-white">{formatCurrency(finalValue)}</span>
          </div>
          <input
