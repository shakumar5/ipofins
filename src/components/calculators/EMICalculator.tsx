      ...
      <div className="space-y-6">
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-bold text-gray-900 dark:text-white">{formatCurrency(principal)}</span>
          </div>
          <input
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-bold text-gray-900 dark:text-white">{rate}% p.a.</span>
          </div>
          <input
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-bold text-gray-900 dark:text-white">{tenure} years</span>
          </div>
          <input
      ...
      <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4 pt-4">
          <div className="text-center">
            ...
            <p className="text-sm font-bold text-gray-900 dark:text-white mt-1">{formatCurrency(principal)}</p>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-bold text-gray-900 dark:text-white mt-1">{formatCurrency(result.totalPayment)}</p>
          </div>
        </div>
      </div>
    </div>
